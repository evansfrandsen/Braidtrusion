...
DummyNode.Node(coordinates=(0.0,0.0,-0.1), label=1000)
DummyNode.SetFromNodeLabels(name='DummyNodeSetPart', nodeLabels=(1000,))

DummyNode2=m.Part(name='DummyNode2')
DummyNode2.Node(coordinates=(0.0,0.0,0.2), label=1001)
DummyNode2.SetFromNodeLabels(name='DummyNodeSetPart2', nodeLabels=(1001,))
...
m.rootAssembly.Instance(dependent=ON, name='DummyNode2-1', part=DummyNode2)
...
DummyNodeSet=m.rootAssembly.SetFromNodeLabels(name='DummyNodeSet', nodeLabels=(('DummyNode-1', (1000, )), ))
DummyNodeSet2=m.rootAssembly.SetFromNodeLabels(name='DummyNodeSet2', nodeLabels=(('DummyNode2-1', (1001, )), ))
############################# History Outputs #################################
...
'''
m.Equation(name='Equation1L', terms=( (-1.0, 'BoundaryConditionsSET', 1), (1.0, 'DummyNodeSet2', 1), ))
m.Equation(name='Equation2L', terms=( (-1.0, 'BoundaryConditionsSET', 2), (1.0, 'DummyNodeSet2', 2), ))

m.Equation(name='Equation1R', terms=( (-1.0, 'ForceSET', 1), (1.0, 'DummyNodeSet', 1), ))
m.Equation(name='Equation2R', terms=( (-1.0, 'ForceSET', 2), (1.0, 'DummyNodeSet', 2), ))

m.Equation(name='Equation2L', terms=( (-1.0, 'BoundaryConditionsSET', 3), (1.0, 'DummyNodeSet2', 3), ))


m.Equation(name='Equation2R', terms=( (-1.0, 'ForceSET', 3), (1.0, 'DummyNodeSet', 3), ))
'''

Name_connector = 'Spring'
Connector = m.ConnectorSection(name= Name_connector, translationalType=AXIAL)
elastic_0 = connectorBehavior.ConnectorElasticity(components=(1, ), table=((10.0, ), ))
...
for i in range(1,len(xyzAx)+1):
    ...
    r11 = m.rootAssembly.instances['DummyNode-1'].nodes
...
for i in range(1,len(xyzAx)+1):
    n1 = m.rootAssembly.instances['M_fiberAx-'+str(i)].nodes
    r11 = m.rootAssembly.instances['DummyNode2-1'].nodes
    Wire = m.rootAssembly.WirePolyLine(points=((n1[-1], r11[0]), ), mergeType=IMPRINT, meshable=OFF)
    edges1 = mdb.models['Model-1'].rootAssembly.edges.findAt((n1[-1].coordinates, ))
...
LoadStp1_ReinfR=m.ConcentratedForce(amplitude='Amp-Die', cf3=0.039682539682, createStepName='Step-1', distributionType=UNIFORM, field='', localCsys=None, name='Load_stp1_ReinfR', region=BCSet)

#Move of Reinforcement fibers to the Die
BraidBCs_Stp1=m.DisplacementBC(amplitude='Amp-Die', createStepName='Step-1', distributionType=UNIFORM, fieldName='', fixed=OFF, localCsys=None, name='BraidBCsL_stp1', region=DummyNodeSet, u1=0.0, u2=0.0, u3=-580E-3, ur1=UNSET, ur2=UNSET, ur3=UNSET)
...
m.DisplacementBC(amplitude=UNSET, createStepName='Step-1', distributionType=UNIFORM, fieldName='', fixed=OFF, localCsys=None, name='BCsPBC2', region=DummyNodeSet2,u1=0.0, u2=0.0, u3=UNSET)
