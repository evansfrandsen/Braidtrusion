...
#for Braiding Yarn fibers
for j in range(Nby):
    for l in range(1,NFiberperYarn+1): 
        k=j*NFiberperYarn+l
        M_FiberBY=M_FibersBY.get("M_PartFiberBY-"+str(k))
...
elastic_0 = connectorBehavior.ConnectorElasticity(components=(1, ), table=((100.0, ), ))#constante de ressort definie ici en N div par m
